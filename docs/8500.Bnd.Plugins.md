...
<table width="100%"><tbody><tr><td>aQute.lib.spring.<span class="wikiword">SpringComponent</span></td><td><span class="wikiword">AnalyzerPlugin</span></td><td>This component will analyze the Spring XML for Spring DM and will add any classes in these files to the referred set of classes.</td></tr>
<tr><td>aQute.bnd.make.<span class="wikiword">MakeBnd</span></td><td><span class="wikiword">MakePlugin</span></td><td>If Include-Resource can't find a referred resource it will use the make plugins to see if any of them can make the requested resource. The <span class="wikiword">MakeBnd</span> has type=bnd. This plugin can recursively call bnd to create embedded jars that are not created sequentially</td></tr>
<tr><td>aQute.bnd.make.<span class="wikiword">MakeCopy</span></td><td><span class="wikiword">MakePlugin</span></td><td>Copies resources from other places in the file system</td></tr>
<tr><td>aQute.lib.deployer.<span class="wikiword">FileRepo</span></td><td><span class="wikiword">RepositoryPlugin</span></td><td>Provides a file based repository.</td></tr>
<tr><td>aQute.bnd.maven.<span class="wikiword">MavenRepository</span></td><td><span class="wikiword">RepositoryPlugin</span></td><td>Provides an interface to a the default maven repository in the user's home directory. Can be used with aQute.bnd.maven.<span class="wikiword">MavenGroup</span> to support converting bundle symbolic names to group and artifact id.</td></tr>
</tbody></table>