...
<tr><td>designate</td><td>CLASS</td><td>Designate a class as a <a class="wikilink" href="Metatype.html">MetaType</a> interface used for configurations for unitary configurations, see <a name="metatype" id="metatype"></a>. This changes the default of the configurationPolicy to <code>require</code>.</td></tr>
<tr><td>designateFactory</td><td>CLASS</td><td>Designate a class as a <a class="wikilink" href="Metatype.html">MetaType</a> interface used for configurations for factory configurations, see . This changes the default of the configurationPolicy to <code>require</code>.</td></tr>
...
<table><tbody><tr><th>bind</th><th>unbind</th></tr>
